...
public class DLProgressBar extends DLGuiComponent {
    ...
    public record BarColorChanged(Color color) implements IEvent {}
    public record BorderColorChanged(Color color) implements IEvent {}
    ...
    public final ColorProperty color = new ColorProperty(Color.GREEN, Color.WHITE)
        .withAfterPropertyChangedCallback((o, val) -> invokeEvent(this, new BarColorChanged(val)));
    public final ColorProperty backgroundColor = new ColorProperty(Color.BLACK, Color.BLACK)
        .withAfterPropertyChangedCallback((o, val) -> invokeEvent(this, new DLGuiCommonEvents.BackgroundColorChangedEvent(val)));
    public final ColorProperty borderColor = new ColorProperty(Color.WHITE, Color.WHITE)
