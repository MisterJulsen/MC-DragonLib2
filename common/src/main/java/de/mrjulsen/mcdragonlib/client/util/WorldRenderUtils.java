...
public final class WorldRenderUtils {
    ...
    public static void addVert(VertexConsumer builder, WorldGraphics graphics, float x, float y, float z, float u, float v, float r, float g, float b, float a, int lu, int lv) {
    ...
    private static void renderWithoutAO(VertexConsumer builder, WorldGraphics graphics, float x0, float y0, float z0, float x1, float y1, float z1, float u0, float v0, float u1, float v1, float r, float g, float b, float a, int packedLight) {
    ...
    public static void addQuadSide(Direction direction, VertexConsumer builder, WorldGraphics graphics, float x0, float y0, float z0, float x1, float y1, float z1, float u0, float v0, float u1, float v1, float r, float g, float b, float a, int packedLight, boolean ambientOcclusion) {
    ...
    public static void renderTexture(ResourceLocation texture, WorldGraphics graphics, Vector3f pos, float w, float h, float u, float v, float uW, float vH, Direction facing, Color tint, int light, boolean ambiebtOcclusion) {
    ...
    public static void renderTexture(ResourceLocation texture, WorldGraphics graphics, Vector3f pos, float w, float h, float u, float v, float uW, float vH, Direction facing, Color tint, boolean ambientOcclusion) {
        renderTexture(texture, graphics, pos, w, h, u, v, uW, vH, facing, tint, graphics.packedLight(), ambientOcclusion);        
    }

    public static void renderTexture(ResourceLocation texture, WorldGraphics graphics, Vector3f pos, float w, float h, Direction facing, boolean ambientOcclusion) {
        renderTexture(texture, graphics, pos, w, h, 0, 0, 1, 1, facing, Color.WHITE, graphics.packedLight(), ambientOcclusion);        
    }    

    // RenderStateShard$TextureStateShard for textureId
    public static void renderTexture(DLTexture texture, WorldGraphics graphics, Vector3f pos, float w, float h, float u, float v, float uW, float vH, Direction facing, Color tint, int light, boolean ambientOcclusion) {
    ...
    public static void renderTexture(DLTexture texture, WorldGraphics graphics, Vector3f pos, float w, float h, float u, float v, float uW, float vH, Direction facing, Color tint, boolean ambientOcclusion) {
        renderTexture(texture, graphics, pos, w, h, u, v, uW, vH, facing, tint, graphics.packedLight(), ambientOcclusion);
    }

    public static void renderTexture(DLTexture texture, WorldGraphics graphics, Vector3f pos, float w, float h, Direction facing, boolean ambientOcclusion) {
        renderTexture(texture, graphics, pos, w, h, 0, 0, texture.width(), texture.height(), facing, Color.WHITE, ambientOcclusion);
    }

    public static void fillColor(WorldGraphics graphics, Vector3f pos, float w, float h, Color color, Direction facing, int light, boolean ambientOcclusion) {
        renderTexture(BLANK_TEXTURE_LOCATION, graphics, pos, w, h, 0, 0, 1, 1, facing, color, light, ambientOcclusion);
    }
    
    public static void fillColor(WorldGraphics graphics, Vector3f pos, float w, float h, Color color, Direction facing) {
        fillColor(graphics, pos, w, h, color, facing, graphics.packedLight(), false);
    }

    public static void drawString(WorldGraphics graphics, Font font, float x, float y, Component text, Color color, ETextAlignment alignment, boolean dropShadow, boolean transparent, Color backgroundColor, int packedLight) {
        float dx = x;
        switch (alignment) {
            case RIGHT:
    ...
    public static void drawString(WorldGraphics graphics, Font font, float x, float y, Component text, Color color, ETextAlignment alignment, boolean dropShadow, int packedLight) {        
        drawString(graphics, font, x, y, text, color, alignment, dropShadow, false, Color.TRANSPARENT, packedLight);
    }

    public static void drawString(WorldGraphics graphics, Font font, float x, float y, Component text, Color color, ETextAlignment alignment, boolean dropShadow) {
        drawString(graphics, font, x, y, text, color, alignment, dropShadow, graphics.packedLight());
    }

    public static void drawString(WorldGraphics graphics, Font font, float x, float y, String text, Color color, ETextAlignment alignment, boolean dropShadow, boolean transparent, Color backgroundColor, int packedLight) {        
        drawString(graphics, font, x, y, TextUtils.text(text), color, alignment, dropShadow, transparent, backgroundColor, packedLight);
    }

    public static void drawString(WorldGraphics graphics, Font font, float x, float y, String text, Color color, ETextAlignment alignment, boolean dropShadow, int packedLight) {        
        drawString(graphics, font, x, y, text, color, alignment, dropShadow, false, Color.TRANSPARENT, packedLight);
    }

    public static void drawString(WorldGraphics graphics, Font font, float x, float y, String text, Color color, ETextAlignment alignment, boolean dropShadow) {
        drawString(graphics, font, x, y, text, color, alignment, dropShadow, graphics.packedLight());
    }
    
    

    public static void drawDebugLineGradient(PoseStack poseStack, VertexConsumer consumer, Vector3f from, Vector3f to, Color colorA, Color colorB) {
    ...
    public static void drawDebugLine(PoseStack poseStack, VertexConsumer consumer, Vector3f from, Vector3f to, Color color) {
        drawDebugLineGradient(poseStack, consumer, from, to, color, color);
    }
    
    public static void drawDebugLineGradient(WorldGraphics graphics, Vector3f from, Vector3f to, Color colorA, Color colorB) {
        drawDebugLine(graphics.poseStack(), graphics.multiBufferSource().getBuffer(RenderType.solid()), from, to, colorB);
    }

    public static void drawDebugLine(WorldGraphics graphics, Vector3f from, Vector3f to, Color color) {
    ...
    protected static void renderNameTag(WorldGraphics graphics, Vector3f pos, float yOffset, List<Component> text, int packedLight) {
