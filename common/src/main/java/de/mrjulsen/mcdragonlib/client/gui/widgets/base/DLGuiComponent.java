...
import de.mrjulsen.mcdragonlib.client.gui.properties.IProperty;
...
public abstract class DLGuiComponent implements IEventDispatcher<DLGuiComponent>, AutoCloseable {
    ...
    public final void renderEvent(DLGuiGraphics graphics, double mouseX, double mouseY, RenderLayer layer, int xOffset, int yOffset, double scrollOffsetX, double scrollOffsetY, Rectangle scissorBounds) {
