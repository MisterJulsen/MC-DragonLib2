...
public class RedWindow extends DLWindow {
    ...
    public void renderMainLayer(Graphics graphics, double mouseX, double mouseY, Rectangle renderBounds) {
        ...
        if (level != null) {
            ...
            GuiUtils.drawString(graphics, graphics.defaultFont(), 10, 10 + graphics.defaultFont().lineHeight * 0, "Daytime: " + level.getDayTime(), DragonLib.NATIVE_UI_FONT_COLOR, ETextAlignment.LEFT, false);
            GuiUtils.drawString(graphics, graphics.defaultFont(), 10, 10 + graphics.defaultFont().lineHeight * 1, "Time: " + DLTime.fromTicks(level.getDayTime(), provider).format(new TimeFormatTicks(), TimeContext.INGAME), DragonLib.NATIVE_UI_FONT_COLOR, ETextAlignment.LEFT, false);
            GuiUtils.drawString(graphics, graphics.defaultFont(), 10, 10 + graphics.defaultFont().lineHeight * 2, "Time: " + DLTime.fromTicks(level.getDayTime(), provider).format(new TimeFormat24Hours(), TimeContext.INGAME), DragonLib.NATIVE_UI_FONT_COLOR, ETextAlignment.LEFT, false);
            GuiUtils.drawString(graphics, graphics.defaultFont(), 10, 10 + graphics.defaultFont().lineHeight * 3, "Time: " + DLTime.fromTicks(level.getDayTime(), provider).format(new TimeFormat24Hours(), TimeContext.REAL), DragonLib.NATIVE_UI_FONT_COLOR, ETextAlignment.LEFT, false);
            GuiUtils.drawString(graphics, graphics.defaultFont(), 10, 10 + graphics.defaultFont().lineHeight * 4, "Time (+1h): " + DLTime.fromTicks(level.getDayTime(), provider).addTicks(1000, v).format(new TimeFormat24Hours(), TimeContext.INGAME), DragonLib.NATIVE_UI_FONT_COLOR, ETextAlignment.LEFT, false);
        
            GuiUtils.drawString(graphics, graphics.defaultFont(), 10, 10 + graphics.defaultFont().lineHeight * 6, "" + DLTime.fromTicks(level.getDayTime(), provider).format(new TimeFormaturVerboseDuration(null, true, true, true, true, true), TimeContext.INGAME), DragonLib.NATIVE_UI_FONT_COLOR, ETextAlignment.LEFT, false);
            GuiUtils.drawString(graphics, graphics.defaultFont(), 10, 10 + graphics.defaultFont().lineHeight * 7, "" + DLTime.fromTicks(level.getDayTime(), provider).format(new TimeFormaturVerboseDuration(null, true, true, true, true, true), TimeContext.REAL), DragonLib.NATIVE_UI_FONT_COLOR, ETextAlignment.LEFT, false);
            
            GuiUtils.drawString(graphics, graphics.defaultFont(), 10, 10 + graphics.defaultFont().lineHeight * 8, "" + DLTime.fromTicks(level.getDayTime(), provider).format(new TimeFormatDigitalDuration(DLTime.fromTicks(12000, provider), false, false, true, true, false), TimeContext.INGAME), DragonLib.NATIVE_UI_FONT_COLOR, ETextAlignment.LEFT, false);
            GuiUtils.drawString(graphics, graphics.defaultFont(), 10, 10 + graphics.defaultFont().lineHeight * 9, "" + DLTime.fromTicks(level.getDayTime(), provider).format(new TimeFormatDigitalDuration(DLTime.fromTicks(12000, provider), false, true, true, false, false), TimeContext.REAL), DragonLib.NATIVE_UI_FONT_COLOR, ETextAlignment.LEFT, false);
            
            GuiUtils.drawString(graphics, graphics.defaultFont(), 10, 10 + graphics.defaultFont().lineHeight * 11, "" + DLTime.fromTicks(level.getDayTime(), provider).format(new TimeFormatISO8601(), TimeContext.INGAME), DragonLib.NATIVE_UI_FONT_COLOR, ETextAlignment.LEFT, false);
            GuiUtils.drawString(graphics, graphics.defaultFont(), 10, 10 + graphics.defaultFont().lineHeight * 12, "" + DLTime.fromTicks(level.getDayTime(), provider).format(new TimeFormatRFC3339(), TimeContext.INGAME), DragonLib.NATIVE_UI_FONT_COLOR, ETextAlignment.LEFT, false);
