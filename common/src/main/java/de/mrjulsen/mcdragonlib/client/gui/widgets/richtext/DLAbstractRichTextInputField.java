...
public abstract class DLAbstractRichTextInputField extends DLRichTextLabel {
    ...
    public void renderMainLayer(DLGuiGraphics graphics, double mouseX, double mouseY, Rectangle renderBounds) {
        ...
        if (text.get() != null && text.get().getPlainText().isEmpty() && placeholderText.get() != null && !isFocused()) {
            GuiUtils.drawString(graphics, font, (int)getLayoutContentX(), (int)(getLayoutContentY() + (lineSpacing.get() / 2f)), placeholderText.get(), DLColor.fromInt(0xFF808080), ETextAlignment.LEFT, false);
        }
    ...
    public void renderTextRangeHighlights(de.mrjulsen.mcdragonlib.client.util.DLGuiGraphics mcGraphics, List<TextRange> ranges, DLColor color) {
    ...
    private void renderSelection(de.mrjulsen.mcdragonlib.client.util.DLGuiGraphics mcGraphics) {
