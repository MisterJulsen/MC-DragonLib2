...
public class DLUnbakedModelExtension implements IUnbakedGeometry<DLUnbakedModelExtension> {
    ...
    @Override
    public BakedModel bake(IGeometryBakingContext ctx, ModelBaker baker, Function<Material, TextureAtlasSprite> spriteGetter, ModelState modelState, ItemOverrides overrides) {
        BakedModel vanilla = parent.bake(baker, parent, spriteGetter, modelState, false);
